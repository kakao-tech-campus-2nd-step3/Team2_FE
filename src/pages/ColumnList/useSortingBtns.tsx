...
/**
 * 컬럼, 상품 리스트에 담길 정렬 버튼들을 생성하는 hook
 ...
 * @returns 정렬 버튼 컴포넌트
 */
export default function useSortingBtns({ btnNames, btnValues }: Props) {
  const { activeState, changeState } = useQueryParam("sortby", btnValues);
  ...
  return { activeState, SortingBtns };
}
